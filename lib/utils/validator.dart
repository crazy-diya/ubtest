class Validator {
  ...
  static bool isValidMobileNumberOnFreshLogin(String mobile) {
    bool valid = false;
    try {
  ...
  static bool validatePassport(String passport) {
    String passport_part1, passport_part2;
    int length = passport.length;
    bool retVal = false;

    try {
      if (length == 8) {
        passport_part1 = passport.substring(0, 1).toLowerCase();
        passport_part2 = passport.substring(1, length);

        if (passport_part1 == "n") {
          try {
            int.parse(passport_part2);
            retVal = true;
          } catch (e) {
            retVal = false;
          }
