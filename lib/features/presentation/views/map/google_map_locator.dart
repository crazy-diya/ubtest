...
class GoogleMapLocator extends BaseView {
  static const CameraPosition _sriLankaMap = CameraPosition(
    target: LatLng(8.2, 80.75),
    zoom: 7.6,
  );

  const GoogleMapLocator({super.key});

  @override
  _GoogleMapLocatorState createState() => _GoogleMapLocatorState();
}

class _GoogleMapLocatorState extends BaseViewState<GoogleMapLocator> {
  ...
  createMarkers() async {
    customIconB = await BitmapDescriptor.asset(
     const ImageConfiguration(),
      AppAssets.locationMarker,
      width: 20,
    );

    customIconR = await BitmapDescriptor.asset(
        const ImageConfiguration(),
       AppAssets.locationMarkerSelected,
       width: 20,
    );
    setState(() {});
  }
  ...
  void initState() {
    super.initState();
    WidgetsBinding.instance.addPostFrameCallback((e)=>createMarkers());
                ...
                children: [
                  GoogleMap(
                    ...
                    markers: Set<Marker>.from((current == 0
                            ...
                            : current == 1
                                ? branchData : current ==2 ? atmData : cdmData // Show ATMs only
                        )
                        .map((location) {
                      ...
                      return Marker(
                        onTap: () {
                          setState(() {
                            _selectedMarker =  location; // Update the selected marker
                            isCardShowing = true;
                          });
                          mapController
                        ...
                        icon: _selectedMarker == location ? customIconR! : customIconB!,
                        position: LatLng(
                    ...
                    initialCameraPosition: GoogleMapLocator._sriLankaMap,
                  ...
                  Container(
                              ...
                              child: SizedBox(
                                ...
                                child: Container(
                                  ...
                                  child: ListView.builder(
                                    ...
                                    itemCount: current == 0
                                        ? searchedList.length
                                        : current == 1 ? searchedBranchList.length : current ==2 ?
                                             searchedAtmList.length : searchedCdmList.length,
                                            ...
                                            child: Column(
                                              children: [
                                                SizedBox(
                                                  height: 30.h,
                                                  child: ListTile(
                                                    selectedColor: colors(context).greyColor,
                                                    contentPadding:
                                                    ...
                                                    title: Text(
                                                        item.merchantName ?? "",style: size16weight400,),
                    ...
                    Visibility(
                      ...
                      child: Column(
                        ...
                        children: [
                          Padding(
                            padding:
                                 EdgeInsets.only(right: 25.w, bottom: 12.99),
                            child: Align(
                    ...
                    Visibility(
                      ...
                      child: Positioned.fill(
                        child: Padding(
                          padding:
                               EdgeInsets.only(right: 25.w, bottom: 12.99 + AppSizer.getHomeIndicatorStatus(context)),
                          child: Align(
                            alignment: Alignment.bottomRight,
                            child: InkWell(
                              onTap: () async {
        ...
        child: SizedBox(
          ...
          child: TextField(
            ...
            decoration:  InputDecoration(
              ...
              prefixIcon: PhosphorIcon(PhosphorIcons.magnifyingGlass(PhosphorIconsStyle.regular),color: colors(context).blackColor,),
