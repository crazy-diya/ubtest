...
class TnCOtherBankView extends BaseView {
  final TermsArgs termsArgs;

  TnCOtherBankView({required this.termsArgs});

  @override
  _TnCOtherBankViewState createState() => _TnCOtherBankViewState();
}

//791662338V
class _TnCOtherBankViewState extends BaseViewState<TnCOtherBankView> {
  final TnCBloc bloc = injection<TnCBloc>();
  String _termsData = '';
  int? _termID = 0;
                  ...
                  child: Column(
                    children: [
                     ...
                     16.verticalSpace,
                      ...
                      // AppSizer.horizontalSpacing(AppSizer.getHomeIndicatorStatus(context))
                    ],
                  ),
                ),
              ],
