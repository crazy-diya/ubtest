...
class MigrateUserTCTermsArgs {
  final String? termsType;
  final String? viewType;
  final String? appBarTitle;

  MigrateUserTCTermsArgs({this.termsType, this.viewType, this.appBarTitle});
}

class MigrateUserTC extends BaseView {
  final MigrateUserTCTermsArgs termsArgs;

  MigrateUserTC({required this.termsArgs});

  @override
  _MigrateUserTCState createState() => _MigrateUserTCState();
}

class _MigrateUserTCState extends BaseViewState<MigrateUserTC> {
            ...
            if (state is TermsLoadedState) {
              ...
              hideProgressBar();
                 ...
                 ToastUtils.showCustomToast(
                        context,
                        state.message ?? AppLocalizations.of(context).translate("success"),
                        ToastStatus.SUCCESS);

             Navigator.pushReplacementNamed(context, Routes.kAddSecurityQuestionView);
            }
