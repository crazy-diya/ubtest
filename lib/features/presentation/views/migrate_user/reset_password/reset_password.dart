...
class ResetPasswordView extends BaseView {
  ...
  @override
  _ResetPasswordViewState createState() =>
      _ResetPasswordViewState();
}

class _ResetPasswordViewState
    extends BaseViewState<ResetPasswordView> {
              ...
              Navigator.pushNamed(context, Routes.kOtpView,
                ...
                if (value != null) {
                  ...
                  if (value == true) {
                    ...
                    Navigator.pushReplacementNamed(context, Routes.kMigrateUserTC,
                        ...
                        child: Column(
                          ...
                          children: [
                           ...
                           Text( AppLocalizations.of(context)
                                  .translate("migrate_password_reset_desc"),
